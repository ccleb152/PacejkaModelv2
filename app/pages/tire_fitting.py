...
# catalog with no setup step. Three .parent hops: this file lives at
# app/pages/tire_fitting.py, so .parent.parent.parent is the repo root.
RAW_DATA_CATALOG_ROOT = Path(__file__).resolve().parent.parent.parent / "RawDataFiles"
